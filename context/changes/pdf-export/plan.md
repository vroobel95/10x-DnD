...
- [x] 1.1 Type checking passes: `npm run typecheck` — 399985b
- [x] 1.2 Linting passes: `npm run lint` — 399985b
- [x] 1.3 Unit tests pass: `npm run test` — 399985b
- [x] 1.4 Unit test asserts `%PDF-` byte signature on output — 399985b
- [x] 1.5 Unit test asserts one page per confirmed enemy — 399985b
- [x] 1.6 Unit test covers optional saves/skills and many/long abilities without throwing — 399985b
- [x] 1.7 Unit test confirms an enemy with invalid `stats` is skipped — 399985b

#### Manual

- [x] 1.8 Generated bytes open as a valid PDF with expected per-enemy pages and readable layout — 2d18aa3

### Phase 2: Export API route + integration tests

#### Automated

- [x] 2.1 Type checking passes: `npm run typecheck` — 2d18aa3
- [x] 2.2 Linting passes: `npm run lint` — 2d18aa3
- [x] 2.3 Integration test: 500 when `createClient` returns null — 2d18aa3
- [x] 2.4 Integration test: 401 when unauthenticated — 2d18aa3
- [x] 2.5 Integration test: 404 on battle not found and 500 on non-not-found battle SELECT error — 2d18aa3
- [x] 2.6 Integration test: 404 when battle not owned (campaign IDOR) — 2d18aa3
- [x] 2.7 Integration test: 404 when no confirmed enemies — 2d18aa3
- [x] 2.8 Integration test: 200 with `application/pdf` + `Content-Disposition` + `%PDF-` body — 2d18aa3

#### Manual

- [x] 2.9 Logged-in request for an owned battle downloads a valid PDF — 2d18aa3
- [x] 2.10 Requesting another user's battle id returns 404 (no data leak) — 2d18aa3
