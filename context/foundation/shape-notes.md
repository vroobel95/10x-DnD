...
Authentication: Login required (email + password or OAuth). No unauthenticated access to the generator.
...
_(No open questions remaining. Competitive insight resolved during Phase 7 quality check.)_
